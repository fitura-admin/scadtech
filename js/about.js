let year = [
    { id: 1, year: '1999', title: 'Создание ООО «РОССКАТавто»', p: 'Производство каталитических нейтрализаторов, каталитических коллекторов, систем выпуска отработавших газов, глушителей-нейтрализаторов', img: '../img/about/2.png', article: 'Первый офис группы компаний (Апрель 1999)' },
    {
...
`, img: '../img/about/2.png', article: ''
    },
    { id: 3, year: '2012', title: 'Запуск нового направления - Нефтегаз', p: 'Автоматизированные системы управления технологическими процессами (АСУТП) и автоматические\nсистемы пожаротушения (АС ПТ) для предприятий нефтегазовой отрасли.', img: '../img/about/2.png', article: '' },
    { id: 4, year: '2013', title: 'Создание компании ООО «АСК Инжиниринг»', p: 'Проекты автоматизированных систем управления и телемеханики (МПСА, АСУ ПТ, СЛТМ) в сфере трубопроводного транспорта нефти и нефтепродуктов, SCADA системы.', img: '../img/about/2.png', article: '' },
    { id: 5, year: '2014', title: 'Создание ООО «РОССКАТавто»', p: 'Производство каталитических нейтрализаторов, каталитических коллекторов, систем выпуска отработавших газов, глушителей-нейтрализаторов', img: '../img/about/2.png', article: '' },
    {
...
Открытие ОП «СКАД тех» в г. Томск`, img: '../img/about/2.png', article: ''
    },
    {
...
`, p: 'Открытие ОП «СКАД тех» в г. Тюмень', img: '../img/about/2.png', article: ''
    },
    {
...
Открытие обособленного подразделения «АСК Инжиниринг» в г. Санкт-Петербурге`, img: '../img/about/2.png', article: ''
    },
    {
